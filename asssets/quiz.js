...
function loadQuestions() {
    ...
    */
    ...
    li2.textContent = nonAnswers[Math.floor(Math.random() * nonAnswers.length)];
    li3.textContent = nonAnswers[Math.floor(Math.random() * nonAnswers.length)];
    li4.textContent = nonAnswers[Math.floor(Math.random() * nonAnswers.length)]
